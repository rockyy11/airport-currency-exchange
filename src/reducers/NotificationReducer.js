...
export default handleActions(
  {
    [combineActions(UPDATE_ADMIN_SETTINGS_FAILURE, FETCH_NEW_RATES_FAILURE, CURRENCIES_LIST_FAILURE, ADMIN_SETTINGS_FAILURE, BUY_CURRENCY_FAILURE, SELL_CURRENCY_FAILURE)]: (state, action) => {
      return {
        ...state,
        isError: true,
